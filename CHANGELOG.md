...
## [0.2.5] - 2026-08-11
### Changed
* Optimized `lz.compress_code` slightly.
### Fixed
* Failing to pack uncompressed code into structure which allows compression.
...
[0.2.5]: https://github.com/ljtpetersen/apnds/compare/v0.2.4...v0.2.5
